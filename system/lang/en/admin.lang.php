...
$L['adm_help_config_rss'] = "Links to open RSS feeds: <br />" . $cfg['mainurl'] . "/" . "rss (by default, the output of news categories specified in the settings) <br /> " . $cfg['mainurl'] . "/" . "rss/pages?c=XX (XX - Category code, the last pages of the category) <br />" . $cfg['mainurl'] . "/" . "rss/comments?id=XX (XX - ID page, comments page) <br />";
...
$L['adm_help_trashcan'] = "Here are listed the items recently deleted by the users and moderators.<br />Wipe : Delete the item forever.<br />Restore : Put the item back in the live database.";
